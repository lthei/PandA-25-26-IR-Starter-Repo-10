# ToDo 0 i (create file_utilities.py and move the Configuration class as well as all file-related functionality there)
...
class Configuration:
    ...
    # ToDo 3 iii (move save_config into the Configuration class and rename it)
    def save(self) -> None:
